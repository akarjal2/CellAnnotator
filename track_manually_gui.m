...
% Last Modified by GUIDE v2.5 08-Dec-2015 14:41:27
...
% %     load Z:\mDrives\raid0\DSLM_WorkInProgress\Exp204_Myosin1\timeStructure.mat timeStructureX timeStructureY
% %     
% %     image_path='Z:\mDrives\storage2\DSLM_Data\Exp204_myosin1\focus\focused_one\focused_Exp196_';
% % 
% %     time_struct_id=10*60+46; % A1
% % 
% %     handles.time_interval=[37 50];
% %     
% %     boundary=60;
...
%     image_path='Z:\mDrives\storage2\DSLM_Data\Exp204_myosin1\focus\focused_one\focused_Exp196_';
% 
%     time_struct_id=11*60+46; % A2
% 
%     handles.time_interval=[100 113];
%     
%     boundary=60;    
...
%     keyboard
    ...
    for time=handles.time_interval(1):handles.time_interval(2)
        ...
        handles.o_imgs(:,:,time-handles.time_interval(1)+1)=imread([image_path num2str(time,'%.04d') '.tif'],'pixelregion',pixels);    
    ...
    antti_evaluate_imagej_script_windows('Z:\mDrives\raid0\DSLM_WorkInProgress\Exp186\antti\0087_edit_time_independent_and_track\bandpass_filter_z-stack.ijm','Z:\mDrives\raid0\DSLM_WorkInProgress\Exp186\antti\0087_edit_time_independent_and_track\temp.tif','Z:\mDrives\raid0\DSLM_WorkInProgress\Exp186\antti\0087_edit_time_independent_and_track\filt_temp.tif');
